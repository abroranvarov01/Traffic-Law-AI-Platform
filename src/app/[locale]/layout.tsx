...
export const metadata: Metadata = {
  title: "ai Assistent",
  description:
    "ai Assistant — aqlli va tez yordamchi, salqin vibe bilan. Savollarga javob beradi, vazifalarga yordam beradi va hayotni osonlashtiradi. 🚀",
};
